 ...
 * @author kong
 */
public class EditEbook extends javax.swing.JInternalFrame {
	...
	int value = fc.showOpenDialog(EditEbook.this);
    ...
    private void EditBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditBookActionPerformed
        ...
        if(!res) {
           ...
           JOptionPane.showMessageDialog(EditEbook.this, "แก้ไขข้อมูลหนังสือสำเร็จ","ข้อความเตือนการแก้ไขข้อมูล",JOptionPane.INFORMATION_MESSAGE);
        }
        else {
           JOptionPane.showMessageDialog(EditEbook.this, "แก้ไขข้อมูลหนังสือไม่สำเร็จ ไม่พบ ID ของคุณ","ข้อความเตือนการแก้ไขข้อมูล",JOptionPane.WARNING_MESSAGE);           
        }         
