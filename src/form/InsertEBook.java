 ...
 * @author kong
 */
public class InsertEBook extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        bookpic.setBounds(610, 230, 140, 150);
	...
	int value = fc.showOpenDialog(InsertEBook.this);
    ...
    private void jAddBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAddBookActionPerformed
         int eBookId = 0;
         Object eBookCover_id=null ;
         String bookname = txtBookName.getText();
         String publisher= txtPublisher.getText();
         String author = txtAuthor.getText();      
         int pricecover = Integer.parseInt(txtPriceCover.getText());
         int price = Integer.parseInt(txtPrice.getText());
         int filesize = Integer.parseInt(txtFileSize.getText());
         int page= Integer.parseInt(txtNumOfPages.getText());
         String filebook = txtBookLink.getText();
         //String type = txtType.getText();
         String category = comboBoxCategory.getSelectedItem().toString();
         System.out.print(filePic);
         Data.Book book = new Data.Book(eBookId,bookname,category,publisher,
            author,filebook,price,pricecover,
            filesize,page, (ObjectId) eBookCover_id );
         
        String message = "";
        if (InsertService.hasEmptyFields(book)) {
            message += "ใส่ข้อมูลไม่ครบ  กรุณาใส่ข้อมูลให้ครบ\n";
        } else {
            if (InsertService.isNameBookEquals(book)) {
                message += "ชื่อหนังสือมีผู้ใช้แล้ว\n";
            }       
        }
        
        if (message.trim().length() > 0) {
            JOptionPane.showMessageDialog(InsertEBook.this, message, "เพิ่มข้อมูลหนังสือไม่สำเร็จ!!", JOptionPane.WARNING_MESSAGE);
        } else {
            
             boolean b = Dao.BookDao.insertBook(book,filePic);          
            JOptionPane.showMessageDialog(InsertEBook.this, "เพิ่มหนังสือสำเร็จ", "", JOptionPane.INFORMATION_MESSAGE);    
        }
